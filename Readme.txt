Простое клиент-серверное приложение, работающее по htttps протоколу. С сервера на клиент передаются текстовые, html и графические файлы.
...
$./build/https-server <номер порта>
...
$./build/https-client <ip-адрес сервера> <номер порта сервера>
